...
public class CantoAsset {
  ...
  public CantoAsset(String name, String ownerName, String time, Long width, Long height, Long dpi, CantoUrls url, String id, String scheme,
      String owner, String description, Long size, List<CantoVersionHistory> versionHistory, @Nullable Map<String, String> additional) {
    this.name = name;
